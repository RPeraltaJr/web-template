...
const paths = {
  styles: {
    scssInput: 'dist/assets/uncompiled/scss/*.scss',
    modules: 'dist/components/**/**/*.scss',
    cssInput: 'dist/assets/uncompiled/css/*.css',
    cssDest: 'dist/assets/uncompiled/css/',
    cssDestMin: 'dist/assets/build/css/',
  },
  scripts: {
    inputs: [
      './dist/assets/uncompiled/js/page-home.js',
    ],
    modules: 'dist/assets/uncompiled/js/modules/*.js',
    dest: 'dist/assets/build/js/',
  },
};
